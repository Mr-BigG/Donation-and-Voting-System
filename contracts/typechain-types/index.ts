...
export type { AwardContract } from "./contracts/AwardContract";
export { AwardContract__factory } from "./factories/contracts/AwardContract__factory";
export type { DonationAndVotingSystemContract } from "./contracts/DonationAndVotingSystemContract";
export { DonationAndVotingSystemContract__factory } from "./factories/contracts/DonationAndVotingSystemContract__factory";
export type { DSOMW } from "./contracts/DSOMW";
export { DSOMW__factory } from "./factories/contracts/DSOMW__factory";
export type { GoldContract } from "./contracts/GoldContract";
export { GoldContract__factory } from "./factories/contracts/GoldContract__factory";
...
export type { StringHelper } from "./contracts/StringHelper";
export { StringHelper__factory } from "./factories/contracts/StringHelper__factory";
