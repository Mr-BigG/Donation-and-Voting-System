...
export interface GoldContractInterface extends utils.Interface {
  functions: {
  ...
  encodeFunctionData(
    functionFragment: "getWhetherUserCanGetInitialUserGold",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface GoldContract extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GoldContractInterface;
